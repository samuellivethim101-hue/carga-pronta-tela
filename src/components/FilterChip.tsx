  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start gap-0.5">
        ...
        <span className="font-bold text-card-foreground text-sm leading-none">{value}</span>
      </div>
      <ChevronDown className="h-3.5 w-3.5 text-muted-foreground/60 transition-transform duration-200 group-hover:text-primary/60 group-hover:translate-y-0.5 ml-1" />
    </button>
  );
};
